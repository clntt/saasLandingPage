...
const Download = () => {
  return (
    <section>
        <Element name='download' className='relative g7 pb-32 pt-24 max-md:py-16'>
            <div className='container'>
                <div className='flex items-center'>
                    <div className='relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100'>
                        ...
                        <p className='body-1 mb-10 max-w-md'>Try it now for free on ios, Android, PC, Web - whatever your flavor we've got you covered.
                        </p>

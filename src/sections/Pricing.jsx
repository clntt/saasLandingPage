    ...
    <section>
        <Element name='pricing'>
            <div className='container'>
                ...
                >
                    {plans.map(({ id, caption, features, icon, logo, priceMonthly, priceYearly, title }, index) => (
                        <div 
                            key={id}
                        ...
                        >
                            ...
                            <div 
                                className={clsx('absolute left-0 right-0 z-2 items-center justify-center', index === 1 ? '-top-6' : '-top-6 xl:-top-11')}
                            >
                            ...
                            >
                                ...
                                <div className='relative z-2 flex items-center justify-center'>
                                    <div
                                        className={clsx('h-num flex items-start', index === 1 ? 'text-p3' : 'text-p4')}
                                    >
                                        $ <CountUp 
                                            start={priceMonthly}
